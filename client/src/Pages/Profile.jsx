...
const Profile = () => {
  return (
    <div className="py-12 px-12 flex gap-4">
      {/* left section */}
      <div className="w-[350px] h-screen bg-slate-500 p-4">
        ...
        <div className="py-4">
          ...
          <div>
            <ul className="flex items-center justify-between gap-2 flex-wrap">
              <li className="p-2 border border-b-neutral-100 rounded-md">
                React
              </li>
              <li className="p-2 border border-b-neutral-100 rounded-md">
                Javascript
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        <div  className="bg-slate-300 p-6 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-8">
                <img className="w-[70px]" src="https://st.llnl.gov/sites/default/files/inline-images/ST_icon.png"/>
